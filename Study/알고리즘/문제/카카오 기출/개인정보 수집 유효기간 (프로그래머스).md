...
// 		for (String t : terms) {
// 			slist = t.split(" ");
// 			term.put(slist[0], slist[1]);
// 		}
// 		for (int i = 0; i < privacies.length; i++) {
// 			slist = privacies[i].split(" ");
// 			endTerm = term.get(slist[1]);
// 			if (todate.compareTo(LocalDate.parse(slist[0], DateTimeFormatter.ofPattern("yyyy.MM.dd")).plusMonths(Long.parseLong(endTerm))) >= 0) {
// 				answer.add(i + 1);
// 			}
// 		}
